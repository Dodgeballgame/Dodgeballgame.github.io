...
|회피|성공률 : (1-공격성공률)/2 %|회피 성공시 상하좌우랜덤으로 1칸이동<br>||
|캐치|성공률 : (1-공격성공률)/2 %|성공시 해당 오브젝트가 공을 ||
...
|이동방향|기준점 기준으로 왼쪽 플레이어들이 던질시 오른쪽으로 이동<br> 기준점 기준으로 오른쪽 플레이어들이 던질시 왼쪽으로 이동|플레이어가 바라보는 방향으로 ||
...
|:---:|:---:|:---:|:---:|
|제공포인트|5포인트|||
|공격|2포인트당 사거리 1칸증가<br>1포인트당 공격성공확률 3퍼증가|||
|이동|3포인트당 이동횟수 1증가|||
|회피|1포인트당 회피확률 3퍼증가|||
|캐치|1포인트당 잡을확률 3퍼증가|||
|지원|1포인트당 패스확률 5퍼증가|||
