...
|이동방향||중앙선 기준으로 왼쪽 플레이어들이 던질시 오른쪽으로 이동<br> 기준점 기준으로 오른쪽 플레이어들이 던질시 왼쪽으로 이동||

> [스킬]

|속성|속성값|설명|비고|
|:---:|:---:|:---:|:---:|
|공격|1. 공격 사거리2칸 증가<br>2. 공격성공확률 20퍼 증가||1번or2번 선택가능|
|회피|1. 회피확률 10퍼 증가|||
|캐치|1. 잡을확률 10퍼증가<br>2. 잡는범위1칸 증가||1번or2번 선택가능|
|지원|1. 랜덤으로 적의 회피확률 15퍼감소<br>2. 랜덤으로 아군의 공격성공확률 15퍼증가||1번or2번 선택가능|
...
|공격|2point당 사거리 1칸증가<br>1point당 공격성공확률 3퍼증가|공격 관련된 특성||
|이동|3point당 이동횟수 1증가|이동 관련된 특성||
|회피|1point당 회피확률 3퍼증가|회피 관련된 특성||
|캐치|1point당 잡을확률 3퍼증가|캐치 관련된 특성||
|지원|1point당 패스확률 5퍼증가|지원 관련된 특성||
|행동력|2point당 행동력 1증가|행동력 관련된 특성||
