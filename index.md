...
|:---:|:---:|:---:|:---:|
|행동력|6point|행동 포인트||
|공격|성공률 : (75*a)% <br>행동력 : 3|공격 성공시 적 플레이어에게 공격권이 넘어감|행동력 3이되면 나머지행동 비활성화|
|회피|성공률 : {(100-공격성공률)/2*b}%|회피 성공시 상하좌우랜덤으로 1칸이동<br>이동할 공간이 없을시 공에 맞게됨||
|캐치|성공률 : {(100-공격성공률-회피성공률)*c}%|성공시 해당 오브젝트가 공을 잡음 ||
...
시작화면, 게임세팅, 게임화면 총 3개의 화면이 있다.
시작화면에는 게임시작, 게임세팅, 게임종료라는 버튼 3개가 있다.
